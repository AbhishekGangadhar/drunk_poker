...
from tests.utils import _ACE_OF_SPACES, _ACE_OF_CLUBS, _ACE_OF_HEARTS, _KING_OF_CLUBS, _QUEEN_OF_CLUBS, \
    _TWO_OF_SPACES, _THREE_OF_CLUBS, _FOUR_OF_HEARTS, _SEVEN_OF_SPACES, _SEVEN_OF_CLUBS, _SEVEN_OF_HEARTS
