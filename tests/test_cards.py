...
class TestCards(TestCase):
    def test(self):
        ...
        self.assertEqual("ACE of SPADES", str(ace_of_spades))
        ...
        self.assertEqual("TWO of HEARTS", str(two_of_hearts))
        ...
        self.assertEqual("SEVEN of CLUBS", str(seven_of_clubs))
        ...
        self.assertEqual("JACK of DIAMONDS", str(jack_of_diamonds))
