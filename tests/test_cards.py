...
class TestCards(TestCase):
    def test(self):
        ...
        self.assertEqual(1, ace_of_spades.get_rank_val())
        ...
        self.assertEqual(2, two_of_hearts.get_rank_val())
        ...
        self.assertEqual(7, seven_of_clubs.get_rank_val())
        ...
        self.assertEqual(11, jack_of_diamonds.get_rank_val())
